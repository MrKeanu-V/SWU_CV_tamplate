...
%----------------- 简历书写原则 -----------------------------------%
% 1. 最关键的几条技能特长和个人简介，总结出不超过三行，放在教育背景之前。
% 2. 项目经历里面应增加对“项目本身的结果/效果”的量化描述，
% 3. 教育背景：特别关键的课程，写在最前面；如果分数高，可以把分数写一下（分数不高就不写了）。
% 4. GPA 3.6以下不用写。
% 5. 按时间倒叙，最近期的应该放在上面，比如教育经历：硕士在本科之上。项目经验同理。
% 6.如果有明确的求职目标，可以写在第一行“个人信息”这四个字的旁边（字体同姓名）。比如：“求职软件开发相关岗位”
% 7.“个人信息”里面需要增加联系方式：电话、邮箱、linkedin个人页面链接
% 8. 全文，需要强调的关键词，全部加粗
...
\newcommand{\contact}{
    ...
    \textcolor{white}{
        ...
        \faEnvelope \quad \href{mailto:warmthwind@163.com}{xxxxx@swu.edu}
        \hspace{4em}
        % GitHub
        \faGithub \quad \href{https://github.com/MrKeanu-V}{MrKeanu-V}
        \hspace{4em}
        % 手机号
        \faPhone \quad  xxx-xxx-xxx（微信同号）
   ...
   %%%%%%%%%  1、页眉页脚  %%%%%%%%%%%
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[anchor=north, inner sep=0pt](header) at (current page.north){
            \includegraphics[width=\paperwidth]{images/swu_header_dark.png}
        }; % 此处修改页眉图片light or dark
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[anchor=south, inner sep=0pt](footer) at (current page.south){
            \includegraphics[width=\paperwidth]{images/swu_footer_dark.png}
        }; % 此处修改页脚图片light or dark
        % 需要更改时直接更改文首的页眉页脚即可
    ...
    % 项目模板2
    \vspace{0.5em}
    {\large{\textbf{XXXX - XXXXXXXX}}} \\ \textbf{项目负责人} \hfill {20XX年X月至20XX年X月}\\
